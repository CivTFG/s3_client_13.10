...
const registerTFCLampFuels = (event) => {
	event.lampFuel('gtceu:creosote', '#tfc:lamps', 21000)
	event.lampFuel('gtceu:oil', '#tfc:lamps', 21000)
	event.lampFuel('gtceu:oil_light', '#tfc:lamps', 21000)
	event.lampFuel('gtceu:oil_medium', '#tfc:lamps', 21000)
	event.lampFuel('gtceu:oil_heavy', '#tfc:lamps', 21000)
	event.lampFuel('gtceu:seed_oil', '#tfc:lamps', 147000)
	event.lampFuel('gtceu:fish_oil', '#tfc:lamps', 147000)
	event.lampFuel('tfg:peanut_oil', '#tfc:lamps', 147000)
	event.lampFuel('tfg:palm_oil', '#tfc:lamps', 147000)
